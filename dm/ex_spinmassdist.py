...
from dm.spinmassdist import FBEqs_Sol as FBSol_SMD    # Mass and Spin Distributions
...
sig_M   = 1.0 # Width of the distribution
...
sig_a   = 0.5 # Width of the spin distribution
pars_SD = sig_a
...
xm, tm, MBHm, astm, SBHm, SRDm, Radm, PBHm, TUnm, NDBEm, Tev  = Oh2m.Solt()
