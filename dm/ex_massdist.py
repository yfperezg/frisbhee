...
from dm.massdist import FBEqs_Sol as FBSol_MD   # Mass Distributions
...
Mi   = 6.  # Peak mass in g at formation  --> Taken here as a parameter
asi  = 0.  # PBH initial rotation a_star factor
bi   = -3. # Initial PBH fraction 
mDM  = 10.  # Log10 @ Dark Matter mass
