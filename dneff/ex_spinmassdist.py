...
from dneff.mono import FBEqs_Sol                         # Monochromatic Scenario
from dneff.spinmassdist import FBEqs_Sol as FBSol_SMD    # Mass and Spin Distributions
...
typ_f = 4*typ_SD + typ_MD

Dis_types = {0:"LN+N", 1:"PL+N", 2:"CC+N", 3:"MP+N", 4:"LN+M", 5:"PL+M", 6:"CC+M", 6:"MP+M"}
...
SolDR = FBSol_SMD(Mi, asi, bi, typ, pars_SMD, sDR)
...
plt.savefig(path+"/plots/Example_solution_DNeff_Mass_Spin_Dist.pdf")
plt.show()
